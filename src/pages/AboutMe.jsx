  ...
  return (
    <div className="mt-10 mx-2 flex flex-col justify-center ">
      <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-10 gap-5 items-center ">
        <div className="relative flex   flex-col items-center gap-2 animate-fade-in  ">
          <img
            src={myImage}
            alt=""
            className="object-cover max-md:h-70 bg-glossy shadow h-80 w-auto rounded-[5%]  grayscale  select-none"
          />
        ...
        <div className="relative   bg-glossy p-2 h-max rounded-xl flex flex-col gap-4 max-w-xl  text-theme text-wrap animate-fade-left ">
          <p className="font-light normal-font-size leading-relaxed">
            Hey, my name is{" "}
            <span className="text-theme font-bold">Krutarth Raval</span> - a
            passionate individual who loves building and creating with intent. I
            find purpose in learning, growing, and shaping ideas into something
            real and impactful. Whether it’s a project or a conversation, I
            believe in showing up with clarity, curiosity, and a desire to leave
      ...
      <div className="flex flex-col sm:gap-10 gap-5 items-start mt-10 text-theme">
          ...
          <div className=" metadata-font-size flex sm:justify-center items-center max-lg:flex-col gap-5 max-sm:gap-5 ">
            ...
            >
              ...
              <p className="mt-1 absolute sm:bottom-3 bottom-2 right-2 sm:right-3 italic text-theme-secondary font-light metadata-font-size flex items-center gap-2 ">
                — Silver Oak University <span className="bg-accent p-2 rounded-md sm:relative group"><FaLocationDot size={20}/><i className="absolute bg-accent px-2 py-1 rounded-md top-1 left-12 sm:top-13 sm:left-1/2 -translate-x-1/2 w-max opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition duration-300 ease-in-out ">Ahmadabad, Gujarat, India</i></span>
              </p>

              <p className="mt-2 font-medium normal-font-size mb-3 flex items-center max-sm:mb-6">
            ...
            >
              ...
              <p className="mt-1 absolute sm:bottom-3 bottom-2 right-2 sm:right-3 italic  text-theme-secondary font-light metadata-font-size flex items-center gap-2">
                — C.M. Vidyalaya School<span className="bg-accent p-2 rounded-md group sm:relative"><FaLocationDot size={20}/><i className="absolute bg-accent px-2 py-1 rounded-md top-1 left-17 sm:top-13 sm:left-1/2 -translate-x-1/2 w-max opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition duration-300 ease-in-out ">Palitana, Gujarat, India</i></span>
              </p>
            </motion.div>
            <motion.div
              ref={eduRef3}
            ...
            >
              ...
              <p className=" absolute sm:bottom-3  bottom-2 right-2 sm:right-3 italic  text-theme-secondary font-light metadata-font-size flex items-center gap-2">
                — C.M. Vidyalaya School<span className="bg-accent p-2 rounded-md group sm:relative"><FaLocationDot size={20}/><i className="absolute bg-accent px-2 py-1 rounded-md top-1 left-17 sm:top-13 sm:left-[-130px] max-sm:-translate-x-1/2  w-max opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition duration-300 ease-in-out ">Palitana, Gujarat, India</i></span>
              </p>
              <p className="mt-2 font-medium normal-font-size mb-3 flex items-center max-sm:mb-6">
                <span className="font-light">Percentile</span>
                <span className="bg-surface py-1 px-3 ml-2 rounded-md font-normal">
        ...
        {/* Expertise Section */}
        <div className="flex flex-col w-full sm:gap-10 gap-5 p-2 items-start  text-theme">
          <h2 className="description-font-size w-full font-semibold mb-3 pb-1 border-b-1 border-theme-accent">
            Expertise
          </h2>
